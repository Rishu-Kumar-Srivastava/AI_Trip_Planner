    ...
    <div className="mt-10">
      <div className="text text-center md:text-left">
        ...
        <p className="text-sm text-gray-600 font-medium mt-3">
          ...
          Make Trip will generate a tailored itinerary based on your
          preferences.
        </p>
      </div>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              <span className="flex gap-2">
                <span>
                  {user
                    ? "Logged In Securely to Make Trip with Google Authentication"
                    : "Sign In to Make Trip with Google Authentication Securely"}
                </span>
              </span>
              {user ? (
                ""
